...
#define FFMPEG_CONFIGURATION "--target-os=android --prefix=../libs-r21e-ffmpeg_build/x86_64 --arch=x86_64 --cpu=x86-64 --nm=../android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android-nm --strip=../android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android-strip --sysroot=../android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/sysroot --enable-asm --enable-avfilter --enable-decoders --enable-cross-compile --enable-neon --enable-hwaccels --enable-small --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-postproc --enable-network --enable-bsfs --enable-filters --enable-encoders --enable-gpl --enable-muxers --enable-parsers --enable-protocols --enable-nonfree --enable-jni --enable-mediacodec --enable-demuxers --enable-shared --disable-static --disable-ffprobe --disable-ffplay --disable-ffmpeg --disable-debug --disable-doc --disable-avdevice --disable-symver --disable-indevs --disable-outdevs --extra-cflags='-Os -fpic -march=x86-64 -msse4.2 -mpopcnt -m64 -mtune=intel -I../libs-r21e-ffmpeg_build/x86_64/include' --extra-ldflags='-lc -ldl -lm -lz -llog -lgcc -L../libs-r21e-ffmpeg_build/x86_64/lib' --cc=../android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android21-clang --cxx=../android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android21-clang++ --cross-prefix=../android-ndk-r21e/toolchains/llvm/prebuilt/linux-x86_64/bin/x86_64-linux-android-"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2022
#define FFMPEG_DATADIR "../libs-r21e-ffmpeg_build/x86_64/share/ffmpeg"
#define AVCONV_DATADIR "../libs-r21e-ffmpeg_build/x86_64/share/ffmpeg"
